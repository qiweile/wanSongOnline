    ...
    <view class="user">
       ...
       <view class="navgraw">
        ...
        <view class="navCell">
            ...
            <!-- <view class="section">
                <view class="section-title">
                    <u-image width="40rpx" height="40rpx" :src="ic_dynamic"></u-image>
                    <text class="u-m-l-20 u-font-14">我的动态</text>
                </view>
                <view class="section-right">
                    <u-icon name="arrow-right"></u-icon>
                </view>
            ...
            <!-- <view class="section">
                <view class="section-title">
                    <u-image width="40rpx" height="40rpx" :src="ic_peach"></u-image>
                    <text class="u-m-l-20 u-font-14">福利中心</text>
                </view>
                <view class="section-right">
                    <u-icon name="arrow-right"></u-icon>
                </view>
            ...
            <!-- <view class="section">
                <view class="section-title">
                    <u-image width="40rpx" height="40rpx" :src="ic_kefu"></u-image>
                    <text class="u-m-l-20 u-font-14">联系客服</text>
                </view>
                <view class="section-right">
                    <u-icon name="arrow-right"></u-icon>
                </view>
            ...
            <!-- <view class="section">
                <view class="section-title">
                    ...
                    <text class="u-m-l-20 u-font-14">公众号</text>
                </view>
                <view class="section-right">
                    <u-icon name="arrow-right"></u-icon>
                </view>
